            ...
            >
              ...
              <div className="flex flex-col items-center" style={{ width: "120px" }}>
                <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <circle cx="50" cy="50" r="47" fill="none" stroke="#2C5F2D" strokeWidth="1.5" />
                  {/* Dashed inner ring */}
                  <circle cx="50" cy="50" r="41" fill="none" stroke="#2C5F2D" strokeWidth="0.6" strokeDasharray="2 2" />
                  {/* Solid inner ring */}
                  <circle cx="50" cy="50" r="37" fill="none" stroke="#2C5F2D" strokeWidth="1" />
                  ...
                  {/* "TWO FINGER FOUNDATION" along top */}
                  <text fontSize="6.5" fill="#2C5F2D" letterSpacing="1.8" fontFamily="Georgia, serif">
                    <textPath href="#topArc" startOffset="50%" textAnchor="middle">TWO FINGER FOUNDATION</textPath>
                  </text>

                  {/* "ISLAMIC EDUCATION" along bottom */}
                  <text fontSize="5.5" fill="#2C5F2D" letterSpacing="1.2" fontFamily="Georgia, serif">
                    <textPath href="#bottomArc" startOffset="50%" textAnchor="middle">ISLAMIC EDUCATION &amp; TRAINING</textPath>
                  </text>

                  {/* Center monogram */}
                  <text x="50" y="46" textAnchor="middle" fontSize="16" fontWeight="700" fill="#2C5F2D" fontFamily="Georgia, serif">TFF</text>
                  {/* Decorative line under TFF */}
                  <line x1="36" y1="49" x2="64" y2="49" stroke="#C9A961" strokeWidth="0.8" />
                  <text x="50" y="57" textAnchor="middle" fontSize="5.5" fill="#2C5F2D" letterSpacing="1" fontFamily="Georgia, serif">EST. 2024</text>

                  {/* Small decorative stars at 3 and 9 o'clock */}
                  <text x="5" y="52" textAnchor="middle" fontSize="5" fill="#C9A961">✦</text>
                  <text x="95" y="52" textAnchor="middle" fontSize="5" fill="#C9A961">✦</text>
                </svg>
              </div>

              {/* Signature */}
              <div className="flex flex-col items-center" style={{ flex: 1, paddingBottom: "2px" }}>
                {/* Signature image */}
                <div style={{
                  position: "relative",
                  display: "flex",
                ...
                {/* Signature line with gold accents */}
                <div style={{
                  display: "flex", alignItems: "center", gap: "4px", marginBottom: "5px",
                }}>
                  <div style={{ width: "18px", height: "1px", background: "linear-gradient(to right, transparent, #C9A961)" }} />
                  <div style={{ width: "100px", height: "1px", backgroundColor: "#9CA3AF" }} />
                  <div style={{ width: "18px", height: "1px", background: "linear-gradient(to left, transparent, #C9A961)" }} />
                </div>
                <div style={{
                  color: "#2C5F2D",
                  fontSize: "9px",
