        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-[24px] border border-gray-200/80 bg-white shadow-[0_4px_12px_rgba(0,0,0,0.06)] p-6 sm:p-8 mb-10 sm:mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#2C5F2D]">What is Islam?</h2>
            </div>
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4">
              <strong className="text-[#2C5F2D]">Islam</strong> means submission to the One God—Allah—in peace. Muslims believe that Allah created the universe, sent guidance through prophets and books, and that life has a purpose: to worship Him, do good, and prepare for the life to come.
            </p>
          ...
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#2C5F2D] mb-3 tracking-tight">
                ...
                <CardContent className="p-4 sm:p-5">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-[#2C5F2D] mb-2">{pillar.title}</h3>
          ...
          <div className="rounded-xl border border-gray-200/80 bg-white shadow-[0_4px_12px_rgba(0,0,0,0.06)] p-6 sm:p-8 mb-12 sm:mb-14">
            <h2 className="text-xl sm:text-2xl font-bold text-[#2C5F2D] mb-4 text-center">
              What Muslims Believe
            </h2>
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed text-center max-w-3xl mx-auto">
              Muslims believe in <strong className="text-[#2C5F2D]">One God (Allah)</strong>, the <strong className="text-[#2C5F2D]">Angels</strong>, the <strong className="text-[#2C5F2D]">Books</strong> (including the Qur’an), the <strong className="text-[#2C5F2D]">Prophets</strong> (from Adam to Noah, Abraham, Moses, Jesus, and Muhammad ﷺ), the <strong className="text-[#2C5F2D]">Day of Judgment</strong>, and that good and bad are by Allah’s will (<strong className="text-[#2C5F2D]">Qadr</strong>). These six articles of faith give Islam its clarity and coherence.
            </p>
          </div>
              ...
              <Link key={step.to} to={step.to} className="group block">
                <Card className="h-full border border-gray-200/80 bg-white rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.06)] hover:border-[#C9A961]/60 hover:shadow-[0_8px_24px_rgba(44,95,45,0.12)] hover:-translate-y-0.5 transition-all duration-200">
                  <CardContent className="p-4 sm:p-5 flex flex-col h-full">
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-[#2C5F2D] mb-2 group-hover:text-[#1f3f21]">
                      {step.title}
                    </h3>
                    <p className="text-gray-600 text-sm leading-relaxed flex-1 mb-3">
                      {step.body}
                    </p>
                    <span className="inline-flex items-center text-sm font-semibold text-[#2C5F2D] group-hover:text-[#C9A961]">
                      {step.label}
