            ...
            {BOOK_DOWNLOADS.map((book) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <a
                      ...
                      className="text-sm sm:text-base font-semibold text-[#1B2A4A] group-hover:text-[#1f3f21] hover:underline underline-offset-2"
                    >
                      {book.title}
                    </a>
                ...
                <button
                  ...
                  className="mt-1 inline-flex items-center justify-center rounded-full border border-[#C9A961]/70 bg-[#C9A961]/10 px-3 py-1 text-xs sm:text-[13px] font-medium text-[#1B2A4A] hover:bg-[#C9A961]/20 hover:border-[#C9A961] transition-colors whitespace-nowrap cursor-pointer disabled:opacity-70 disabled:cursor-wait"
                >
